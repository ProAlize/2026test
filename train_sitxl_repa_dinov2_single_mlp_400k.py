...
# 注入 SiT 路径（包含正确的 models.py 和 transport/）
SIT_REPO_DIR = "/mnt/tidal-alsh01/dataset/redaigc/yuantianshuo/2026/models/SiT"
if SIT_REPO_DIR not in sys.path:
    sys.path.insert(0, SIT_REPO_DIR)
...
def main(args):
    ...
    if args.repa:
        ...
        sit_hidden_dim = model.x_embedder.proj.out_channels
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--prediction", type=str, default="velocity",
