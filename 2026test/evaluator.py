...
def main():
    ...
    parser.add_argument("ref_batch", help="path to reference batch npz file",default='/mnt/tidal-alsh01/dataset/redaigc/yuantianshuo/2026/eval/ref_imagenet256.npz')
    parser.add_argument("sample_batch", help="path to sample batch npz file",default='/mnt/tidal-alsh01/dataset/redaigc/yuantianshuo/2026/eval/samples_dit_xl_sasa_stepdecay_80k_0080000.npz')
